...
// Brand green — the app's single primary hue, also the Tabata "rest" phase color.
...
// Signal red — encodes the Tabata "work" phase, never used decoratively.
val Red500 = Color(0xFFE5484D)
val Red700 = Color(0xFFB3282D)

// Green-tinted graphite neutrals.
