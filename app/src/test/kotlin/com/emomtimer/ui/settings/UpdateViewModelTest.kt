...
import com.emomtimer.data.update.ApkInstaller
import com.emomtimer.data.update.DownloadStatus
import com.emomtimer.data.update.UpdateCheckCache
import com.emomtimer.data.update.UpdateDownloader
...
class UpdateViewModelTest {
    ...
    fun setUp() {
        ...
        every { context.packageName } returns "com.emomtimer"
        every { packageManager.getPackageInfo("com.emomtimer", 0) } returns packageInfo
    }
